...
Version  : 20240117
Release  : 43
URL      : https://github.com/iputils/iputils/archive/20240117/iputils-20240117.tar.gz
Source0  : https://github.com/iputils/iputils/archive/20240117/iputils-20240117.tar.gz
...
cd %{_builddir}/iputils-20240117
pushd ..
cp -a iputils-20240117 buildavx2
popd
pushd ..
cp -a iputils-20240117 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707078905
...
CC=gcc-14
CFLAGS="$CFLAGS -march=x86-64-v3 -mapxf -mavx10.1 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 -mapxf -mavx10.1 "  meson --libdir=lib64 --prefix=/usr --buildtype=plain -DBUILD_MANS=true \
-DBUILD_HTML_MANS=false   builddirapx
...
/usr/bin/elf-move.py apx %{buildroot}-va %{buildroot} %{buildroot}/usr/share/clear/filemap/filemap-%{name} --skip-path /usr/bin/ping
...
/VA/usr/bin/arping
/VA/usr/bin/clockdiff
/VA/usr/bin/tracepath
/usr/bin/arping
/usr/bin/clockdiff
/usr/bin/tracepath
