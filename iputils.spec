...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707414944
...
GOAMD64=v3
CC=gcc-14
CFLAGS="$CFLAGS -march=x86-64-v3 -mapxf -mavx10.1 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 "  meson --libdir=lib64 --prefix=/usr --buildtype=plain -DBUILD_MANS=true \
