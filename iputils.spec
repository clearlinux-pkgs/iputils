...
Source0  : https://github.com/iputils/iputils/archive/20211215/iputils-20211215.tar.gz
...
%prep
%setup -q -n iputils-20211215
cd %{_builddir}/iputils-20211215
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663618476
...
cp %{_builddir}/iputils-%{version}/ninfod/COPYING %{buildroot}/usr/share/package-licenses/iputils/894a01b2e7d7a684a85caa5bc604ed48d25d9393
